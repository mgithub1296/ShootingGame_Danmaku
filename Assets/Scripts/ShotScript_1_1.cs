...
public class ShotScript_1_1 : MonoBehaviour
{
    // 弾のPrefab
    ...
    IEnumerator KeepShot()
    {
        ...
        //Playerが死ぬまで繰り返す
        while (Player != null || canShot != false)
        {
            ...
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                Debug.Log("ShotDirectionの座標" + this.transform.position);
